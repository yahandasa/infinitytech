              ...
              {navLinks.map((link) => {
                ...
                return (
                  ...
                  >
                    {label}
                    <span className={cn(
                      "absolute bottom-1.4 left-4 right-4 h-px bg-gradient-to-r from-transparent via-primary to-transparent rounded-full transition-transform duration-300 ease-out origin-center",
